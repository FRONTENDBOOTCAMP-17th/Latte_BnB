...
export class FormImage {
  ...
  #buildElement(mode) {
    ...
    if (mode !== constants.FORM_MODE.VIEW) {
      ...
      button.className =
        'imageDeleteBtn bsolute border-2 border-primary-700 bg-primary-500 text-white top-2 right-2 hover:bg-primary-500/80 p-1 rounded-xl';
      button.innerHTML = `
